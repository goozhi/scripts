...
class Jcbz_hfbc_rjyf_mcvn {
    constructor(rjyf_mcvn) {
        ...
        this.hfbc_rjyf_mcvn = () => {
            ...
            new Hfbc_ll_ae_ud_yfm_mcvn(/^.m/).set_xcmj_bnl_da_y_ztka_lh(['q', 'p', 'b']).set_reye_da_vy_yfm('m-').hfbc_zv_da_vy_lh_serm()
            ...
            new Hfbc_ll_ae_ud_yfm_mcvn(/^.o/).set_xcmj_bnl_da_y_ztka_lh(['o', 'j', 'k', 'l', 'e', 'u', 'a', 'i', 'x']).hfbc_zv_da_y_lh_djo()
            ...
            new Hfbc_ll_ae_ud_yfm_mcvn(/.m$/).set_w_ud_yfm_wdbu(true).set_xcmj_bnl_da_y_ztka_lh(['e', 'u', 'p', 'q', 'i', 'x']).hfbc_zv_da_y_lh_hese_yfm()
