/**
 * @param {string} [rjse_yhrj_sjbx] yhrj sjbx java rjqt dk rjse
 * @param {string} [rjse_ztwm] ztwm java rjqt rjse
 * @param {string} [ybsb_vn] ahus mcvn, ybsb vn, if 'abcdefghijklmnopqrstuvwyzx'
 * @returns {object} if: {"aak":"推"} kfji nooa dk afoa.
 */
