...
function wfqq_1(vnwm_kp = ['diwr_data_kp', {}], vnwm_ce = ['diwr_data_ce', {}], diwr_msg = new Diwr_err('stst va nvcm'), vn_wfqq_livn = 0) {
        ...
        if (diwr_data_ce.hasOwnProperty(fo1)) {
            ...
            if (uxux_kp === 'object') {
                if (typeof diwr_data_ce[fo1] != "object") {
                    ...
                    vn_wfqq_livn++
                    if (vn_wfqq_livn < 999) {
                        wfqq_1([vnwm_kp[0] + " n vxn diwr", yg1], [vnwm_ce[0] + " n vxn diwr", diwr_data_ce[fo1]], diwr_msg, vn_wfqq_livn)
                    }
                }
...
function vbyt_lr_diwr_bqeo_stst_va(diwr_data_kp = {}, diwr_data_ce = {}, neig_kp = {}) {
    const neig = Object.assign({ neig_kp, gosi_hqtz: false }, neig_kp)
    const diwr_msg_1 = wfqq_1(['diwr_kp', diwr_data_kp], ['diwr_ce', diwr_data_ce], new Diwr_err('vbyt lr diwr bqeo stst va'), 0)
    if (neig.gosi_hqtz) {
        return diwr_msg_1
    }else{
        const diwr_msg_2 = wfqq_1(['diwr_ce', diwr_data_ce], ['diwr_kp', diwr_data_kp], new Diwr_err('vbyt lr diwr bqeo stst va 2 lil zjzj'), 0)
